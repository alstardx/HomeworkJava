...
// (Например, dogBobik.run(150); -> 'Бобик пробежал 150 м.');
    ...
    public void run( int distance){
        ...
        if (distance <= distanceMaxRun ){
            System.out.println(typeAnimal + " " + name + " пробежал " + distance + "м");
        }
        else {
            System.out.println(typeAnimal + " " + name + " пробежал всего " + distanceMaxRun + "м" + " и умер");
        }
    }
    public void swim( int distance) {
        this.distance = distance;
        if (distance <= distanceMaxSwim) {
            System.out.println(typeAnimal + " " +  name + " проплыл " + distance + "м");
        } else {
            System.out.println( typeAnimal + " " + name + " проплыл всего " + distanceMaxSwim + "м" + " и утонул");
        }
    }
